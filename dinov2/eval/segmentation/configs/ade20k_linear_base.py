...
custom_imports = dict(imports=["dinov2.eval.segmentation.models", "dinov2.eval.segmentation.hooks"])
...
# DINOv2/DVT ADE20K linear-probe optimization protocol.
...
model = dict(
    ...
    decode_head=dict(
        type="BNHead",
        in_channels=[1],  # overridden by each backbone config
        in_index=[3],
